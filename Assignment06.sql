...
-- 2022-05-20,Wei Wang,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_WeiWang')
	 Begin 
	  Alter Database [Assignment06DB_WeiWang] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_WeiWang;
	 End
	Create Database Assignment06DB_WeiWang;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_WeiWang;
